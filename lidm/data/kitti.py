...
class KITTI360Train(KITTI360Base):
    def __init__(self, **kwargs):
        super().__init__(data_root='/inspire/hdd/project/robot-dna/liangxiujian-253308390319/kitti/KITTI-360/', split='train', **kwargs) ##### modified here according to the new path of KITTI-360 dataset,


class KITTI360Validation(KITTI360Base):
    def __init__(self, **kwargs):
        super().__init__(data_root='/inspire/hdd/project/robot-dna/liangxiujian-253308390319/kitti/KITTI-360/', split='val', **kwargs)
...
class AnnotatedKITTI360Train(AnnotatedKITTI360Base):
    def __init__(self, **kwargs):
        super().__init__(data_root='/inspire/hdd/project/robot-dna/liangxiujian-253308390319/kitti/KITTI-360/', split='train', cats=BBOX_CATS, **kwargs)
...
class KITTIImageTrain(KITTIImageBase):
    def __init__(self, **kwargs):
        super().__init__(data_root='/inspire/hdd/project/robot-dna/liangxiujian-253308390319/kitti/', split='train', **kwargs) #####


class KITTIImageValidation(KITTIImageBase):
    def __init__(self, **kwargs):
        super().__init__(data_root='/inspire/hdd/project/robot-dna/liangxiujian-253308390319/kitti/', split='val', **kwargs) #####
